    ...
    >
      <div className="mx-auto w-full max-w-7xl px-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          {/* Logo image: place your logo at public/gradely-logo.svg */}
          <Link href="/" className="flex items-center gap-3">
            <Image src="/gradely-logo.svg" alt="Gradely logo" width={36} height={36} className="rounded-md logo-orbit" />
            <span className="font-semibold logo-orbit">Gradely</span>
          </Link>
        </div>
        <nav className="flex items-center gap-2">
          ...
          <Link href="/">
            <Button size="sm" className="glass-button btn-animate">
              Open Editor
            </Button>
          </Link>
        </nav>
